...
Bag(){
    ...
    //---------------------------------------------------------------------
    lbl1 = new JLabel("Mumu 3009 Retro PU Leather Shoulder Bag - Metal Lock for Women & Students");
    lbl1.setBounds(50, 100, 600, 20);
    add(lbl1 );

    lbl1Price = new JLabel("135");
    ...
    lbl3 = new JLabel("JNK Large Capacity Unisex Backpack Korean College Women Men School Bags");
    lbl3.setBounds(50, 230, 600, 20);
    add(lbl3 );

    lbl3Price = new JLabel("135");
...
//----------------------------------------------------------------------
    ...
    lbl2 = new JLabel("BH3100 Large Capacity Nylon Dumpling Crossbody Bag Shoulder Bag with Purse");
    lbl2.setBounds(50, 360, 600, 20);
    add(lbl2 );


    lbl2PRice = new JLabel("70");
