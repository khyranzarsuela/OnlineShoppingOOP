...
Shoes(){
    ...
    //---------------------------------------------------------------------
    lbl1 = new JLabel("adidas Running Duramo SL Shoes Women Purple");
    lbl1.setBounds(50, 100, 600, 20);
    add(lbl1 );

    lbl1Price = new JLabel("2907");
    ...
    lbl3 = new JLabel("Running Ultrarun 5 W Running Shoes Women White ");
    lbl3.setBounds(50, 230, 600, 20);
    add(lbl3 );

    lbl3Price = new JLabel("4500");
...
//----------------------------------------------------------------------
    ...
    lbl2 = new JLabel("ANTA Women Travel 2.5 PG 7 Sports Shoes Widefoot 2E Cushioning Rebound Running Shoes");
    lbl2.setBounds(50, 360, 600, 20);
    add(lbl2 );


    lbl2PRice = new JLabel("3995");
